    ...
    t.fn.railsAutocomplete = function () {
        ...
        init: function (e) {
            ...
            e.delimiter = t(e).attr("data-delimiter") || null, e.min_length = t(e).attr("min-length") || 2, e.append_to = t(e).attr("data-append-to") || null, e.autoFocus = t(e).attr("data-auto-focus") || !1, t(e).autocomplete({
                ...
                source: function (a, r) {
                    var n = this.element[0], o = {term: i(a.term)};
                ...
                change: function (e, a) {
                    if (t(this).is("[data-id-element]") && "" !== t(t(this).attr("data-id-element")).val() && (t(t(this).attr("data-id-element")).val(a.item ? a.item.id : "").trigger("change"), t(this).attr("data-update-elements"))) {
                        var i = t.parseJSON(t(this).attr("data-update-elements")), r = a.item ? t(this).data(a.item.id.toString()) : {};
                ...
                select: function (i, r) {
                    ...
                    var n = a(this.value);
                    if (n.pop(), n.push(r.item.value), null != e.delimiter) n.push(""), this.value = n.join(e.delimiter); else if (this.value = n.join(""), t(this).attr("data-id-element") && t(t(this).attr("data-id-element")).val(r.item.id).trigger("change"), t(this).attr("data-update-elements")) {
                        var o = r.item, l = -1 != r.item.value.indexOf("Create New") ? !0 : !1, u = t.parseJSON(t(this).attr("data-update-elements"));
