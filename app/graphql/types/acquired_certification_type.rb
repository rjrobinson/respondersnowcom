...
module Types
  class AcquiredCertificationType < Types::BaseObject
    ...
    field :acquired_on, GraphQL::Types::ISO8601DateTime, null: false, description: "Timestamp of date acquired"
    field :certification, Types::CertificationType, null: false
    field :ceus, Integer, null: true
    field :expires, Boolean, null: false
    field :expires_on, GraphQL::Types::ISO8601DateTime, null: true, description: "Timestamp of expiration"
